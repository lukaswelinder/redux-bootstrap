...
function bootstrap(options) {
    ...
    var store = configure_store_1.default(middlewares.concat([routerMddlwr]), rootReducer, immutableInitialState, devToolsOptions);
    var history = react_router_redux_1.syncHistoryWithStore(routerHistory, store, {
        selectLocationState: reselect_1.createSelector(getRouting, function (routing) { return routing.toJS(); })
    });
